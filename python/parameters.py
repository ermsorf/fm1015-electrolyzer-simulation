...
ANODE_REFERENCE_INJECTION = "problem 4"
ANODE_REFERENCE_VOLUME = ANODE_SEPARATOR_VOLUME / 3
ANODE_KP = 1e3

CATHODE_REFERENCE_VOLUME = CATHODE_SEPARATOR_VOLUME / 3
CATHODE_KP = 20
