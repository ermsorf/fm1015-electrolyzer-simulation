...
# PARAMETERS
SYSTEM_TEMPERATURE = 60 + CELSIUS_TO_KELVIN
...
VALVE_SCALING_PRESSURE = 1*BAR_TO_PA  # Pa
...
MIN_TANK_PRESSURE = 0.0*BAR_TO_PA # Pa
MAX_TANK_PRESSURE = 16*BAR_TO_PA # Pa
MIN_TANK_TEMPERATURE = 0.05 + CELSIUS_TO_KELVIN # K
MAX_TANK_TEMPERATURE = 200.05 + CELSIUS_TO_KELVIN # K
