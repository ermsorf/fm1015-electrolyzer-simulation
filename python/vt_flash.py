...
# liquid saturation
water_saturation_pressure = 10**(ANTOINE_A - ANTOINE_B/(ANTOINE_C+T+KELVIN_TO_CELSIUS))*BAR_TO_PA #Saturation pressure of H2O at T (54) [Pa]
SATURATION_A = 2.23
...
#Fugacity
fugacity_liquid_saturation_H2O = phi_liquid_saturation_H2O*water_saturation_pressure 
...
def vtflash(V,T,n):
    ...
    mols_liquid[0] = (fugacity_liquid_saturation_H2O*V-n[0]*T*R)/(fugacity_liquid_saturation_H2O*specific_saturation_volume_H2O-R*T)
